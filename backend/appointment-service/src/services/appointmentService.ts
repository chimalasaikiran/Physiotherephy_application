...
export class AppointmentService {
  ...
  static async createAppointmentWithValidation(params: CreateAppointmentInput): Promise<any> {
    ...
    try {
      if (params.doctorId) {
        const therapistRef = db.collection('therapists').doc(params.doctorId);
        await therapistRef.set(
          {
            assignedPatientIds: FieldValue.arrayUnion(params.userId),
      ...
      console.warn('Therapist patient association warning:', tErr);
    }
